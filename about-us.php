...
<body>
    ...
    <main class="main-content">
        <!-- Hero: About AEQUIFIN title + description -->
        ...
        <!-- Who is AEQUIFIN? (content only, without extra heading) -->
        <section id="who-is-aequifin" class="content-section no-animate">
            <div class="story-section who-section">
                <div class="story-content who-layout">
                    ...
                    <div class="who-video">
                        <div class="who-video-wrapper" data-video-id="1103528334">
                            <div class="who-video-link">
                                <img 
        ...
        <!-- Interactive Ecosystem Visualization (gamified section) -->
            ...
            <div class="ecosystem-visualization">
                    <div class="ecosystem-text-column">
                        ...
                        <div class="ecosystem-item" data-target="lawyers">
                            <h4>LAWFIRMS</h4>
                            <p>
                                <strong class="highlight-value">Lawfirms</strong> can find sponsors for existing mandates and conduct litigation. They also gain access to new clients.
                            </p>
                        </div>
                    ...
                    <div class="ecosystem-visual-column">
                        <div class="ecosystem-diagram">
                            <svg class="ecosystem-svg" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <text x="200" y="60" text-anchor="middle" dominant-baseline="middle" class="node-label" fill="#64748b" font-size="15" font-weight="600">LAWFIRMS</text>
                                <text x="200" y="132" text-anchor="middle" class="node-subtext" data-entity="lawyers">
                                    <tspan x="200" dy="0">Bring legal expertise</tspan>
                                    <tspan x="200" dy="14">and manage cases</tspan>
                                </text>
                                ...
                                <text x="321.24" y="270" text-anchor="middle" dominant-baseline="middle" class="node-label" fill="#64748b" font-size="15" font-weight="600">LITIGANTS</text>
                                <text x="321.24" y="342" text-anchor="middle" class="node-subtext" data-entity="litigants">
                                    <tspan x="321.24" dy="0">Shift legal cost risk</tspan>
                                    <tspan x="321.24" dy="14">and access funding</tspan>
                                </text>
                                ...
                                <text x="78.76" y="270" text-anchor="middle" dominant-baseline="middle" class="node-label" fill="#64748b" font-size="15" font-weight="600">SPONSORS</text>
                                <text x="78.76" y="342" text-anchor="middle" class="node-subtext" data-entity="sponsors">
                                    <tspan x="78.76" dy="0">Provide capital</tspan>
                                    <tspan x="78.76" dy="14">and share in returns</tspan>
                                </text>
                            </svg>
                        </div>
                    </div>
                ...
                <div class="trust-feature-content">
                    <div class="trust-feature-text">
                        ...
                        <div class="trust-feature-actions">
                            <a href="https://www.aequifin.com/de/faqs/" class="button-primary">View Our Process</a>
                        </div>
                    </div>
                    <div class="trust-feature-visual">
                        <div class="trust-visual-card trust-numbers-card">
                            <div class="trust-visual-header">
                                <h4>AEQUIFIN in Numbers</h4>
                            </div>
                            <div class="trust-numbers-list">
                                <div class="trust-number-row">
                                    <div class="trust-number-value">&gt;100</div>
                                    <div class="trust-number-label">Law firms registered</div>
                                </div>
                                <div class="trust-number-row">
                                    <div class="trust-number-value">76%</div>
                                    <div class="trust-number-label">Repeat sponsors</div>
                                </div>
                                <div class="trust-number-row">
                                    <div class="trust-number-value">€250M</div>
                                    <div class="trust-number-label">In case inquiries</div>
                                </div>
                                <div class="trust-number-row">
                                    <div class="trust-number-value">3X</div>
                                    <div class="trust-number-label">Average multiple</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="team-grid-equal">
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/arndt_company.jpg" alt="Dr. Arndt Eversberg">
                    </div>
                    <div class="member-info">
                        <h4>Dr. Arndt Eversberg</h4>
                        <p class="member-role">Senior Advisor</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Dr. Arndt Eversberg">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
                                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path>
                                </svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Dr. Arndt Eversberg">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/ludwig_company.jpg" alt="Ludwig Zoller">
                    </div>
                    <div class="member-info">
                        <h4>Ludwig Zoller</h4>
                        <p class="member-role">CEO, Litigation Financing Expert</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Ludwig Zoller">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
                                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path>
                                </svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Ludwig Zoller">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
                                    <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path>
                                </svg>
                            </a>
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/antonia_company.jpg" alt="Antonia Zoller">
                    </div>
                    <div class="member-info">
                        <h4>Antonia Zoller</h4>
                        <p class="member-role">Senior Consultant</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Antonia Zoller">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
                                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path>
                                </svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Antonia Zoller">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
                                    <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path>
                                </svg>
                            </a>
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/frank_company.jpg" alt="Frank Martin Binder">
                    </div>
                    <div class="member-info">
                        <h4>Frank Martin Binder</h4>
                        <p class="member-role">Managing Director at AEQUIFIN</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Frank Martin Binder">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
                                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path>
                                </svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Frank Martin Binder">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
                                    <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path>
                                </svg>
                            </a>
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/Patrick Biagosch.jpg" alt="Dr. Patrick Biagosch">
                    </div>
                    <div class="member-info">
                        <h4>Dr. Patrick Biagosch</h4>
                        <p class="member-role">Lawyer &amp; Co-Founder AEQUIFIN</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Dr. Patrick Biagosch">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Dr. Patrick Biagosch">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/Stefan Schmidt-Ammon AEQUIFIN.jpg" alt="Stefan Schmidt-Ammon">
                    </div>
                    <div class="member-info">
                        <h4>Stefan Schmidt-Ammon</h4>
                        <p class="member-role">Economist &amp; Co-Founder AEQUIFIN</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Stefan Schmidt-Ammon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Stefan Schmidt-Ammon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
                            </a>
                        </div>
                    </div>
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/taha-hamdi.jpg" alt="Taha Hamdi">
                    </div>
                    <div class="member-info">
                        <h4>Taha Hamdi</h4>
                        <p class="member-role">Junior Developer</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Taha Hamdi">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Taha Hamdi">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
                            </a>
                        </div>
                    </div>
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/iheb-khemila1.png" alt="Iheb Khemila">
                    </div>
                    <div class="member-info">
                        <h4>Iheb Khemila</h4>
                        <p class="member-role">Junior Developer and SEO Expert</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Iheb Khemila">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Iheb Khemila">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
                            </a>
                        </div>
                    </div>
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/Mattihas-brinkmann.jpg" alt="Matthias Brinckman">
                    </div>
                    <div class="member-info">
                        <h4>Matthias Brinckman</h4>
                        <p class="member-role">Limittrustee AEQUIFIN &amp; Lawyer</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Matthias Brinckman">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Matthias Brinckman">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
                            </a>
                        </div>
                    </div>
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/Burkhard-Lohmann.png" alt="Burkhard Lohmann">
                    </div>
                    <div class="member-info">
                        <h4>Burkhard Lohmann</h4>
                        <p class="member-role">Auditor</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Burkhard Lohmann">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Burkhard Lohmann">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
                            </a>
                        </div>
                    </div>
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/thomas-m%C3%BCller.1024x1024.jpg" alt="Dr. Thomas Müller">
                    </div>
                    <div class="member-info">
                        <h4>Dr. Thomas Müller</h4>
                        <p class="member-role">Chairman of the Board</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Dr. Thomas Müller">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Dr. Thomas Müller">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
                            </a>
                        </div>
                    </div>
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/Kim Kardel Farbe horizontal gespiegelt.png" alt="Kim Kardel">
                    </div>
                    <div class="member-info">
                        <h4>Kim Kardel</h4>
                        <p class="member-role">Member of the Board</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Kim Kardel">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Kim Kardel">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
                            </a>
                        </div>
                    </div>
                ...
                <div class="team-member-card">
                    <div class="member-avatar">
                        <img src="assets/oswald_wolfgang.jpg" alt="Wolfgang Oswald">
                    </div>
                    <div class="member-info">
                        <h4>Wolfgang Oswald</h4>
                        <p class="member-role">Tax advisor, lawyer and member of the supervisory board</p>
                        <div class="member-actions">
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="member-social-link" aria-label="View LinkedIn profile of Wolfgang Oswald">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                            </a>
                            <a href="mailto:info@aequifin.com" class="member-social-link" aria-label="Email Wolfgang Oswald">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
                            </a>
                        </div>
                    </div>
                ...
                <div class="team-member-detail" style="display:none;">
                    <div class="detail-content">
                        ...
                        <div class="detail-info">
                            ...
                            <div class="detail-key-info">
                                <p class="detail-company">AEQUIFIN GmbH</p>
                                <p class="detail-location">Munich, Germany</p>
                            </div>
                            <a href="https://www.linkedin.com/company/aequifin/" target="_blank" rel="noopener" class="detail-linkedin">
        ...
        <section class="content-section">
            ...
            <div class="solutions-grid-3col">
                ...
                <div class="solution-card">
                    ...
                    <p>The platform provides IT infrastructure and litigation funding know-how for the preparation of specific legal proceedings for lawyers, companies, institutions and private individuals.</p>
                    <a href="#" class="solution-link">More information</a>
                </div>
            </div>
        </section>
        ...
        <section class="content-section">
            ...
            <div class="media-mentions">
                ...
                <div class="media-mention">
                    <div class="media-outlet">Manager Magazin</div>
                    <p class="media-quote">"Müller ist dabei, sich gut 50.000 Euro für ihre Klage über die Prozessfinanzierungsplattform Aequifin zu besorgen."</p>
                    <a href="https://www.manager-magazin.de/unternehmen/industrie/francotyp-postalia-investor-rolf-elgeti-ist-mit-neuer-klage-konfrontiert-a-e4be3914-7171-4e32-88ce-a935ab5c27a0" class="media-link" target="_blank" rel="noopener noreferrer">Read Article →</a>
                </div>
            </div>
        </section>
        ...
        <section class="content-section testimonials-section">
            <div class="ts-head">
                <h2>Testimonials</h2>
                <div class="ts-nav">
                    <button class="testimonial-arrow testimonial-arrow-left" type="button" aria-label="Previous">&#8249;</button>
                    <button class="testimonial-arrow testimonial-arrow-right" type="button" aria-label="Next">&#8250;</button>
                </div>
            </div>
            <div class="swiper ts-swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide testimonial-card">
                        ...
                        <p class="testimonial-quote">Ich darf die Sponsoren darüber informieren, dass nicht nur die Urteilsgründe „unseres“ Falles, sondern nunmehr auch eines weiteren Falles nunmehr vorliegen. Wir haben auch in diesem zweiten Fall auf ganzer Linie gewonnen! Ich danke Ihnen nochmals sehr dafür, dass Sie das alles ermöglicht haben mit Ihrer Finanzierung.</p>
                        <div class="testimonial-author"><div class="testimonial-avatar"><img src="assets/dirk-legler.jpg" alt="Dr. Dirk Legler"></div><div class="testimonial-author-text"><p class="testimonial-name">Dr. Dirk Legler, Rechtsanwalt</p><a href="https://www.aequifin.com/de/" class="testimonial-cta">Zur Einschätzung von Dr. Dirk Legler →</a></div></div>
                    </div>
                    <div class="swiper-slide testimonial-card">
                        <div class="testimonial-mark">“</div>
                        <p class="testimonial-quote">Die Unterstützung durch AEQUIFIN und die Sponsoren hat sich im Verfahren sehr bemerkbar gemacht. Man hatte einfach eine gewisse Sicherheit und konnte sich zusammen mit dem Juristen auf den Fall konzentrieren. Man hat auch das finanzielle Polster und muss nicht gleich klein beigeben, wenn man im Recht ist.</p>
                        <div class="testimonial-author"><div class="testimonial-avatar"><img src="assets/gabriel-Guareshi1.png" alt="Gabriel Quareschi"></div><div class="testimonial-author-text"><p class="testimonial-name">Gabriel Quareschi, Immobilienunternehmer</p></div></div>
                    </div>
                    <div class="swiper-slide testimonial-card">
                        <div class="testimonial-mark">“</div>
                        <p class="testimonial-quote">Die Gegenpartei hat den Geschäftsführer des von mir verwalteten Unternehmens unter Druck gesetzt, dass er in der Insolvenz sowieso keine Mittel für einen Prozess haben würde. Und so wäre es auch gekommen, wenn es die Firma AEQUIFIN nicht gegeben hätte, die die Prozessfinanzierung ermöglichte. Insbesondere auch Dank an alle Sponsoren, die hier mit eingestiegen sind und eine Rechtsfortbildung ermöglicht haben.</p>
                        <div class="testimonial-author"><div class="testimonial-avatar"><img src="assets/josef-hingerl.png" alt="Dr. Josef Hingerl"></div><div class="testimonial-author-text"><p class="testimonial-name">Dr. Josef Hingerl, Insolvenzverwalter und Rechtsanwalt</p></div></div>
                    </div>
                    <div class="swiper-slide testimonial-card">
                        <div class="testimonial-mark">“</div>
                        <p class="testimonial-quote">Ich unterstütze AEQUIFIN, weil ich es spannend finde, dass man durch Sponsoring an einer Prozessfinanzierung beteiligt ist. AEQUIFIN schafft Fairness, weil dadurch oft Prozessfinanzierung erst möglich gemacht werden kann.</p>
                        <div class="testimonial-author"><div class="testimonial-avatar"><img src="assets/kathrin-lohmann.jpg" alt="Kathrin Lohmann"></div><div class="testimonial-author-text"><p class="testimonial-name">Kathrin Lohmann, Sponsorin und Aktionärin</p></div></div>
                    </div>
                </div>
            </div>
        </section>
